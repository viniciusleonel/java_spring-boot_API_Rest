# Use uma imagem base que possui suporte para Java e Maven
...
COPY --from=build /voll_med_api/target/vollmed-0.0.1-SNAPSHOT.jar /voll_med_api/vollmed-0.0.1-SNAPSHOT.jar
